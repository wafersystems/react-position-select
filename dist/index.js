...
var PositionSelect = function PositionSelect(_ref) {
  ...
  var makeItem = function makeItem(v) {
    ...
    }, (!selectItem || v.id !== selectItem.id) && v.name, selectItem && v.id === selectItem.id && /*#__PURE__*/React__default.createElement("span", {
      style: {
        color: selectColor
      }
    }, v.name));
  ...
  var makeChose = function makeChose(choseList) {
    return /*#__PURE__*/React__default.createElement("div", null, choseList.map(function (v, index) {
      if (index === choseList.length - 1 && !_.isEmpty(v.children)) {
        ...
        })), makeItem(v)), /*#__PURE__*/React__default.createElement("div", {
          className: styles.itemDiv
        }, /*#__PURE__*/React__default.createElement("div", {
          className: styles.dotDiv
        }, /*#__PURE__*/React__default.createElement("div", {
    ...
    }), choseList.length === 0 && /*#__PURE__*/React__default.createElement("div", {
      className: styles.itemDiv
    }, /*#__PURE__*/React__default.createElement("div", {
      className: styles.dotDiv
    }, /*#__PURE__*/React__default.createElement("div", {
  ...
  var makeSelect = function makeSelect(selectList) {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
    ...
    }, /*#__PURE__*/React__default.createElement(antdMobile.List, null, list.map(function (v) {
      var disabled = false;
      ...
      return disabled ? '' : /*#__PURE__*/React__default.createElement(Item, {
        key: v.id,
        disabled: disabled,
        onClick: function onClick() {
          handleSelect(v, v.children);
        },
        extra: selectItem && v.id === selectItem.id ? /*#__PURE__*/React__default.createElement(antdMobile.Icon, {
          type: "check"
        }) : ''
  ...
  return /*#__PURE__*/React__default.createElement(antdMobile.Modal, {
    popup: true,
    closable: true,
    title: title,
...
var Item$1 = antdMobile.List.Item;
...
var Position = function Position(_ref) {
  ...
  var makeSelect = function makeSelect(selectList) {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      return disabled ? '' : /*#__PURE__*/React__default.createElement(Item$1, {
        key: v.id,
        disabled: disabled,
        onClick: function onClick() {
          handleSelect(v, v.children);
  ...
  _createClass(PosModel, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(antdMobile.Modal, {
        ...
        onClose: onClose,
        animationType: "slide-up"
      }, spaceTree1 && spaceTree1.length > 0 ? /*#__PURE__*/React__default.createElement(antdMobile.Tabs, {
        tabs: tabs
      }, /*#__PURE__*/React__default.createElement(Position, {
        spaceTree: spaceTree,
        selectTip: selectTip,
...
exports.PositionSelect = PositionSelect;
