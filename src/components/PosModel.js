            ...
            >
                {spaceTree1 && spaceTree1.length > 0 ? (
                    <Tabs
                        tabs={tabs}
                    >
                        <Position spaceTree={spaceTree} selectTip={selectTip} defaultValue={defaultValue}
                                  selectColor={selectColor} selectFilter={selectFilter} onChange={onChange}
                                  primaryColor={primaryColor}/>
                        <Position spaceTree={spaceTree1} selectTip={selectTip} defaultValue={defaultValue1}
                                  selectColor={selectColor} selectFilter={selectFilter} onChange={onChange1}
                                  primaryColor={primaryColor}/>
                    </Tabs>
                ) : <Position spaceTree={spaceTree} selectTip={selectTip} defaultValue={defaultValue}
                              selectColor={selectColor} selectFilter={selectFilter} onChange={onChange}
